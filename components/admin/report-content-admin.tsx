...
interface ReportContentAdminProps {
...
export default function ReportContentAdmin({ content, updateContent, onSave, onReset }: ReportContentAdminProps) {
  return (
    <Card className="shadow-lg border-0 bg-white">
      ...
      <CardContent className="space-y-8 p-8">
        ...
        <div className="space-y-3">
          <Label htmlFor="genomicsExplanation" className="text-lg font-semibold text-gray-800">
            🔬 What is Genomics?
          </Label>
          <Textarea
            id="genomicsExplanation"
            value={content.genomicsExplanation}
            onChange={(e) => updateContent("genomicsExplanation", e.target.value)}
        ...
        <div className="space-y-3">
          <Label htmlFor="genesHealthImpact" className="text-lg font-semibold text-gray-800">
        ...
        <div className="space-y-3">
          <Label htmlFor="fundamentalsPRS" className="text-lg font-semibold text-gray-800">
        ...
        <div className="space-y-3">
          <Label htmlFor="utilityDoctors" className="text-lg font-semibold text-gray-800">
        ...
        <div className="space-y-3">
          <Label htmlFor="microarrayExplanation" className="text-lg font-semibold text-gray-800">
            🔬 Microarray Explanation
          </Label>
          <Textarea
            id="microarrayExplanation"
            value={content.microarrayExplanation}
            onChange={(e) => updateContent("microarrayExplanation", e.target.value)}
        ...
        <div className="space-y-3">
          <Label htmlFor="microarrayData" className="text-lg font-semibold text-gray-800">
